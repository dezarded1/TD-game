...
class HUD:
    ...
    def draw(self,screen):
        ...
        screen.blit(health_text,(1,self.hud_height/5-7))

        money_text = FONT_VERY_SMALL.render(f"COINS: {self.money}", True, YELLOW)
        screen.blit(money_text, (1, self.hud_height/3))
